...
<body>
    ...
    <div class="breadcrumb-section" style="background-image: linear-gradient(270deg, rgba(0, 0, 0, .3), rgba(0, 0, 0, 0.3) 101.02%), url(https://island.lk/wp-content/uploads/2024/01/tourist-arrivels-in-sri-lanka.jpg);">
        <div class="container">
            <div class="row">
