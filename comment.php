...
<body>
    ...
    <div class="breadcrumb-section" style="background-image: linear-gradient(270deg, rgba(0, 0, 0, .7), rgba(0, 0, 0, 0.5) 101.02%), url(https://island.lk/wp-content/uploads/2024/01/tourist-arrivels-in-sri-lanka.jpg);">
        <div class="container">
            <div class="row">
