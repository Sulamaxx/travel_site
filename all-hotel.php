...
?>
    ...
    <?php include "include/admin/dashboard-header.php"; ?>
        <title>Travel Zoom Lanka - All Hotel</title>
    </head>
        ...
        <script>
            function loadToursData() {
                ...
                fetch('loadHotelDataProcess.php?key=' + searchTour+ "&limit=" + <?= $limit; ?> + "&offset=" + <?= $offset; ?>, {
                    ...
                    .then(data => {
                        // alert(data)
                        document.getElementById('hotelsLoadingArea').innerHTML = data;
            ...
            function changeStatus(x, y) {
                fetch('changeHotelStatusProcess.php?key=' + x + "&id=" + y, {
                        method: "GET",
                    })
                    .then(res => res.text())
                    .then(data => {
