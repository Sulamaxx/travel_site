...
if (empty($data['name'])) {
...
} else if (empty($data['hotel_name'])) {
    echo "Please see and select required {$data['subject']}";
    ...
    try {
        ...
        $mail->isHTML(true);
        $mail->Subject = "New {$data['subject']} Booking Form Submission";
        ...
        $mail->Body = "<html>
                        ...
                        <body>
                        <div class='container'>
                            <h1>{$data['subject']} Booking Form Submission</h1>
                            ...
                            <p><span class='label'>Selected {$data['subject']}:</span> {$data['hotel_name']}</p>
