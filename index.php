...
<body>
                        ...
                        <div class="swiper package-card-slider mb-60">
                            <div class="swiper-wrapper">
                                ...
                                ?>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="package-card3" style="height: 700px;">
                                            ...
                                            <div class="package-card-content">
                                                <div class="card-content-top">
                                                    ...
                                                    <h5 style=" height: 1.5em; overflow: hidden;"><a href="package-details.php?id=<?= $data['id'] ?>"><?= $data['title'] ?></a></h5>
    ...
    <section class="kf_summer_offers overlay-blue" style="background-size: cover; background-position: center;background-repeat: no-repeat; background-image: url(assets/img/cover2.png); ">
        <div class="container" style="height: 600px;display: flex;flex-direction: column;align-items: center;justify-content: center;">
        ...
        <div class="container">
            ...
            <div class="row gy-5 mb-80">
                <div class="col-xl-4 col-md-6">
                    <div class="feature-card style-2" style="height: 200px;">
                ...
                <div class="col-xl-4 col-md-6 pt-15">
                    <div class="feature-card style-2 secondary" style="height: 200px;">
                        <div class="feature-card-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="70" height="70" viewBox="0 0 70 70">
    ...
    <div class="banner5-card">
        ...
        <a href="package-details.php" class="primary-btn2">Book a Trip
            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none">
