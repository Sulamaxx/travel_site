...
?>
    ...
    <body class="tt-magic-cursor style-2">
        ...
        <script>
            document.getElementById('paragraphs').addEventListener('change', () => {
                ...
                for (let dayCount = 1; dayCount <= element.value; dayCount++) {
                    ...
                    dayDiv.innerHTML = `<div class="row">
                                    <label for="name${dayCount}">Paragraph ${dayCount}</label>
                                    <div class="col-md-6">
                                        <div class="form-inner mb-30">
                                            <label>Add title</label>
                                            <input type="text" placeholder="Title here..." id="title${dayCount}">
                                        </div>
                                    </div>
                                    <div class="col-md-12 mb-30">
                                        <div class="form-inner">
