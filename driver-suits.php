...
<body>
    ...
    <div class="breadcrumb-section" style="background-image: linear-gradient(270deg, rgba(16, 12, 8, 0.2) 0%, rgba(16, 12, 8, 0.2) 101.02%), url(https://www.sltda.gov.lk/images/s2.jpg);">
        <div class="container">
            <div class="row">
