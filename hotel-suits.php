...
<body>
    ...
    <div class="breadcrumb-section" style="background-image: linear-gradient(270deg, rgba(0, 0, 0, .3), rgba(0, 0, 0, 0.3) 101.02%), url(https://www.sltda.gov.lk/images/home-stay-cover.jpg);">
        <div class="container">
            <div class="row">
