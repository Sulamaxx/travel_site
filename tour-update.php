...
?>
    ...
    <head>
        ...
        <title>Travel Zoom Lanka - Update Tour</title>
    ...
    <body class="tt-magic-cursor style-2">
        ...
        <div class="dashboard-wrapper">
            ...
            $result_tour = Database::search("SELECT * FROM tour WHERE id='" . $_GET['id'] . "'");
            $data_rs = $result_tour->fetch_assoc();
            ?>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-inner mb-30">
                                                <label>Title</label>
                                                <input type="text" value="<?= $data_rs['title'] ?>" id="title">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-inner mb-30">
                                                <label>Days</label>
                                                <input type="number" value="<?= $data_rs['days'] ?>" min="1" oninput="validity.valid||(value='');" id="days">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-12 mb-30">
                                            <div class="form-inner">
                                                ...
                                                <textarea id="description"><?= $data_rs['description'] ?></textarea>
                                            </div>
                                        </div>

                                    </div>
                                    <?php
                                    $image_path = $data_rs['img'];
                                    // echo $image_path;
                                    ?>
        ...
        <script>
            async function LoadDaysData() {
                ...
                $object = [];
                $dayCount = 1;
                $result_days = Database::search("SELECT * FROM day WHERE tour_id='" . $_GET['id'] . "'");
                ...
                for (let dayCount = 0; dayCount < data.length; dayCount++) {
                    ...
                    dayDiv.innerHTML = `<div class="row">
                                <label for="name${dayCount + 1}">Day ${dayCount + 1}</label>
                                <div class="col-md-6">
                                    <div class="form-inner mb-30">
                                        <label hidden id="old${dayCount + 1}" >${data[dayCount].id}</label>
                                        <label>Name</label>
                                        <input type="text" value="${data[dayCount].name}" id="name${dayCount + 1}">
                                    </div>
                                </div>
                                <div class="col-md-12 mb-30">
                                    <div class="form-inner">
        ...
        <script>
                ...
                if (newDays < existingDays) {
                    ...
                    for (let dayCount = existingDays + 1; dayCount <= newDays; dayCount++) {
                        ...
                        dayDiv.innerHTML = `<div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-inner mb-30">
                                                        <label hidden id="old${dayCount}" >None</label>
            ...
            function uploadData() {
                ...
                formData.append('tour_id', <?= $_GET['id'] ?>);
                ...
                fetch('updateTourProcess.php', {
                    ...
                    .then(result => {
                        ...
                        if (result === "Tour updated successfully") {
                            window.location.href = "all-tour.php";
                        }
                    })
                    .catch(error => {
