...
?>
    ...
    <?php include "include/admin/dashboard-header.php"; ?>
        <title>Travel Zoom Lanka - Update Hotel</title>
    </head>
    ...
    <body class="tt-magic-cursor style-2">
        ...
        <div class="dashboard-wrapper">
            ...
            $result = Database::search("SELECT * FROM hotel WHERE id='" . $_GET['id'] . "'");
                        ...
                        <div class="dashboard-profile-wrapper two">
                            <div class="dashboard-profile-tab-content">
                                <form>
                                    ...
                                    <div class="form-inner">
                                        <button type="button" class="primary-btn3" id="btnClick" onclick="addHotel();">Update Now</button>
                                    </div>
                                </form>
                            </div>
                        </div>
            ...
            function addHotel() {
                ...
                fetch('updateHotelProcess.php', {
                    ...
                    .then(data => {
                        ...
                        if (data === "Hotel updated successfully") {
                            window.location.href = "all-hotel.php";
                        }
                    })
                    .catch(error => {
